...
public class Consultas extends Paciente {
    ...
    /**
     * Revisar y analizar los campos necesario para esta insercion.
     */
    private static final String INSERT
            = "INSERT INTO V_CONSULTAS (ID_PACIENTE, ID_CONTROL_CONSULTA, FECHA, TURNO, ESTADO, IDUSUARIO) "
            + "VALUES ('ID_PACIENTE', 'ID_CONTROL_CONSULTA', 'FECHA', 'TURNO', 'ESTADO', 'IDUSUARIO*');";
