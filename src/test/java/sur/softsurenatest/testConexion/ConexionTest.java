...
public class ConexionTest {
    ...
    public void agregarPaciente(){
        Paciente p = Paciente.builder().idPadre(0).idMadre(1).
                cedula("012-0089344-9").pNombre("Jhadiel").sNombre("Jhoandry").
                apellidos("Diaz Paniagua").sexo('m').id_Ars(1).noNSS("1234").
                id_Tipo_Sangre(3).
                fecha_Nacimiento(new Date(new GregorianCalendar(2017, 06, 23).
                        getTimeInMillis())).estado(Boolean.TRUE).build();
        
        String resp = InsertMetodos.agregarPaciente(p);
        
        Assert.assertEquals("Paciente agregado correctamente", resp);
    }
